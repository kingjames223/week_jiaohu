...
<div class="mn wk_sq_mn">
    ...
    <div id="sd" class="sd wk_f_sd">
      ...
      <div class="mb10"><!--[diy=wk_bkad_diy1]--><div id="wk_bkad_diy1" class="area"></div><!--[/diy]--></div>
        ...
        <div class="wk_kd260 padding15 backfff">
            <div class="wk_opkf">
                <span class="wk_spac">官方QQ群</span>
                <div class="clear"></div>
                <div class="wk_topyb cl">
                    <p class="wk_font1">684504192</p>
                    <p class="wk_font2">加入有机会获得公开课录播视频</p>
                </div>
                <ul class="cl">
                    <li><a href="http://wpa.qq.com/msgrd?v=3&uin=2133576719&site=qq&menu=yes" target="_blank" title="$forum_lang[17]"><i class="wk_ico1"></i>$forum_lang[17]</a></li>
                    <li class="last"><a target="_blank" href="https://jq.qq.com/?_wv=1027&k=5zW3KZv" title="$forum_lang[19]"><i class="wk_ico1"></i>技术交流群</a></li>
                </ul>
            </div>
        </div>
        <div class="clear"></div>
